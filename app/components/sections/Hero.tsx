      ...
      <div className="wrap hero-grid">
        <div className="hero-copy">
          ...
          <Reveal as="h1" delay={1}>
            Building Digital Products That <span className="grad-text">Move Businesses</span> Forward.
          </Reveal>
        ...
        <Reveal delay={2}>
          <div className="hero-visual" id="heroVisual" ref={visualRef}>
            <svg viewBox="0 0 600 560" width="100%" height="100%" style={{ overflow: "visible" }}>
              <defs>
                ...
                <filter id="soft" x="-50%" y="-50%" width="200%" height="200%">
                  <feDropShadow dx="0" dy="14" stdDeviation="18" floodColor="#2D2D2D" floodOpacity="0.12" />
                </filter>
              </defs>

              {/* connecting lines */}
              <g stroke="url(#lineGrad)" strokeWidth="2" fill="none" opacity="0.85">
                <path id="pathA" d="M300 260 L140 150" />
                <path id="pathB" d="M300 260 L470 120" />
                <path id="pathC" d="M300 260 L120 380" />
                <path id="pathD" d="M300 260 L460 400" />
                <path id="pathE" d="M300 260 L300 480" />
              </g>
              <g fill="url(#cardGrad)">
                <circle cx="140" cy="150" r="3.5">
                  <animate attributeName="r" values="3.5;5;3.5" dur="2.4s" repeatCount="indefinite" />
                </circle>
                <circle cx="470" cy="120" r="3.5">
                  <animate attributeName="r" values="3.5;5;3.5" dur="2.1s" repeatCount="indefinite" />
                </circle>
                <circle cx="120" cy="380" r="3.5">
                  <animate attributeName="r" values="3.5;5;3.5" dur="2.7s" repeatCount="indefinite" />
                </circle>
                <circle cx="460" cy="400" r="3.5">
                  <animate attributeName="r" values="3.5;5;3.5" dur="2.3s" repeatCount="indefinite" />
                </circle>
                <circle cx="300" cy="480" r="3.5">
                  <animate attributeName="r" values="3.5;5;3.5" dur="2.6s" repeatCount="indefinite" />
                </circle>
              </g>
              ...
              <g filter="url(#soft)">
                ...
                <polyline points="222,304 240,290 258,298 276,278 294,286 312,270 330,282 348,268 366,276" fill="none" stroke="url(#cardGrad)" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" />
              </g>

              {/* laptop, top-left */}
              <g filter="url(#soft)" transform="translate(60,90)">
              ...
              {/* cloud, bottom-left */}
              <g filter="url(#soft)" transform="translate(50,340)">
                <path d="M20 40 a20 20 0 010-40 h40 a24 24 0 010 48 h-46 a16 16 0 01-4-8z" fill="#fff" />
                <path d="M20 40 a20 20 0 010-40 h40 a24 24 0 010 48 h-46 a16 16 0 01-4-8z" fill="url(#cardGrad)" opacity="0.10" />
              </g>

              {/* code window, bottom-right */}
              <g filter="url(#soft)" transform="translate(390,340)">
              ...
              {/* base node */}
              <g filter="url(#soft)" transform="translate(255,450)">
