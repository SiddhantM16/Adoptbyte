    ...
    <section id="about">
      <div className="wrap about-grid">
        <Reveal className="about-illustration">
          <svg viewBox="0 0 500 520" width="100%" height="100%">
            <defs>
        ...
        <div>
          <Reveal>
            ...
            <p style={{ color: "var(--ink-soft)", marginTop: "16px", fontSize: "15.5px", maxWidth: "520px" }}>
              ADOPTBYTE started as a two-person engineering studio and grew into a full-service
              partner for founders and enterprise teams who need software that performs under
              real-world pressure — not just demo day.
            </p>
          </Reveal>
          ...
          <Reveal delay={1} className="timeline">
            <div className="timeline-item">
              ...
              <h4>Studio founded</h4>
              <p>Two engineers, one client, a commitment to craft over shortcuts.</p>
            </div>
            <div className="timeline-item">
              <div className="yr">2020</div>
              <h4>Enterprise-ready</h4>
              <p>Expanded into cloud architecture and compliance-grade systems.</p>
            </div>
            <div className="timeline-item">
              <div className="yr">2023</div>
              <h4>AI practice launched</h4>
              <p>Began embedding ML and automation into client products.</p>
            </div>
            <div className="timeline-item">
              <div className="yr">2026</div>
              <h4>180+ products shipped</h4>
              <p>Trusted by teams across 14 countries and counting.</p>
            </div>
          </Reveal>
          ...
          <Reveal delay={2} className="values-row">
            <div className="value-card">
              <h5>Mission</h5>
              <p>Turn ambitious ideas into dependable software.</p>
            </div>
            <div className="value-card">
              <h5>Vision</h5>
              <p>Set the standard for enterprise-grade engineering.</p>
            </div>
            <div className="value-card">
              <h5>Values</h5>
              <p>Craft, transparency, and long-term partnership.</p>
            </div>
          </Reveal>
        </div>
      </div>
